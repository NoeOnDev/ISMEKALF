...
return [
    ...
    | versiones, como las reglas de tamaño. No dudes en ajustar cada uno de estos
    | mensajes según tus necesidades.
    |
    */
    ...
    | usando la convención "attribute.rule" para nombrar las líneas. Esto agiliza
    | la especificación de un mensaje de idioma personalizado específico para una
