            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            <h3 class="text-lg font-medium mb-4 pb-2 border-b">Sección 1: Datos Generales y de Identificación</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="cb_key" id="cb_key" value="{{ old('cb_key', $product->cb_key) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="batch" id="batch" value="{{ old('batch', $product->batch) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="group" id="group" value="{{ old('group', $product->group) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="mb-6">
                            <h3 class="text-lg font-medium mb-4 pb-2 border-b">Sección 2: Datos de Clasificación y Origen</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="specialty_area" id="specialty_area" value="{{ old('specialty_area', $product->specialty_area) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="brand_reference" id="brand_reference" value="{{ old('brand_reference', $product->brand_reference) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="mb-6">
                            <h3 class="text-lg font-medium mb-4 pb-2 border-b">Sección 3: Datos Operativos y Adicionales</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="manufacturer_unit" id="manufacturer_unit" value="{{ old('manufacturer_unit', $product->manufacturer_unit) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="freight_company" id="freight_company" value="{{ old('freight_company', $product->freight_company) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" min="0" name="freight_cost" id="freight_cost" value="{{ old('freight_cost', $product->freight_cost) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
