                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <p class="text-sm"><span class="font-medium">Modelo:</span> {{ $product->model ?? 'N/A' }}</p>
                                <p class="text-sm"><span class="font-medium">Cantidad:</span> {{ $product->quantity }}</p>
                                <p class="text-sm"><span class="font-medium">Marca:</span> {{ $product->brand->name ?? 'N/A' }}</p>
                                <p class="text-sm"><span class="font-medium">Proveedor:</span> {{ $product->supplier->name ?? 'N/A' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            <div class="bg-gray-50 p-4 rounded-lg mb-4">
                                ...
                                <p class="text-sm"><span class="font-medium">Clave CB:</span> {{ $product->cb_key ?? 'N/A' }}</p>
                                <p class="text-sm"><span class="font-medium">Número de Serie:</span> {{ $product->serial_number ?? 'N/A' }}</p>
                                <p class="text-sm"><span class="font-medium">Lote:</span> {{ $product->batch ?? 'N/A' }}</p>
                                <p class="text-sm"><span class="font-medium">Grupo:</span> {{ $product->group ?? 'N/A' }}</p>
                            </div>

                            <div class="bg-gray-50 p-4 rounded-lg">
                                <h3 class="text-lg font-semibold mb-2">Clasificación y Origen</h3>
                                <p class="text-sm"><span class="font-medium">Área/Especialidad:</span> {{ $product->specialty_area ?? 'N/A' }}</p>
                                <p class="text-sm"><span class="font-medium">Referencia Marca:</span> {{ $product->brand_reference ?? 'N/A' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-span-1">
                            <div class="bg-gray-50 p-4 rounded-lg mb-4">
                                ...
                                <p class="text-sm"><span class="font-medium">Ubicación:</span> {{ $product->location ?? 'N/A' }}</p>
                                <p class="text-sm"><span class="font-medium">Unidad de Medida:</span> {{ $product->manufacturer_unit ?? 'N/A' }}</p>
                                <p class="text-sm"><span class="font-medium">Fletera:</span> {{ $product->freight_company ?? 'N/A' }}</p>
                                ...
                                <p class="text-sm"><span class="font-medium">Caducidad:</span>
                                    {{ $product->expiration_date ? $product->expiration_date->format('d/m/Y') : 'N/A' }}</p>
                            </div>

                            <div class="bg-gray-50 p-4 rounded-lg">
                                <h3 class="text-lg font-semibold mb-2">Información Adicional</h3>
                                <p class="text-sm"><span class="font-medium">Descripción:</span></p>
                                <p class="text-sm mt-1 text-gray-600">{{ $product->description ?? 'Sin descripción' }}</p>
