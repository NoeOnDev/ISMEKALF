        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" x-data="{ activeTab: 1 }">
                        @csrf
                            ...
                            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center">
                                <li class="mr-2">
                                    <button type="button" class="inline-block p-4"
                                        :class="activeTab === 1 ? 'text-blue-600 border-b-2 border-blue-600' : 'hover:text-gray-600 hover:border-gray-300'"
                                        @click="activeTab = 1">
                                        Datos Generales
                                    </button>
                                </li>
                                <li class="mr-2">
                                    <button type="button" class="inline-block p-4"
                                        :class="activeTab === 2 ? 'text-blue-600 border-b-2 border-blue-600' : 'hover:text-gray-600 hover:border-gray-300'"
                                        @click="activeTab = 2">
                                ...
                                <li class="mr-2">
                                    <button type="button" class="inline-block p-4"
                                        :class="activeTab === 3 ? 'text-blue-600 border-b-2 border-blue-600' : 'hover:text-gray-600 hover:border-gray-300'"
                                        @click="activeTab = 3">
                                        Datos Operativos
                                    </button>
                                </li>
                        ...
                        <div x-show="activeTab === 1" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="cb_key" class="block mt-1 w-full" type="text" name="cb_key" :value="old('cb_key')" />
                        ...
                        <div x-show="activeTab === 2" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="brand_id" name="brand_id" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="specialty_area" class="block mt-1 w-full" type="text" name="specialty_area" :value="old('specialty_area')" />
                                ...
                                <div>
                                    ...
                                    <select id="supplier_id" name="supplier_id" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="brand_reference" class="block mt-1 w-full" type="text" name="brand_reference" :value="old('brand_reference')" />
                        ...
                        <div x-show="activeTab === 3" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="manufacturer_unit" class="block mt-1 w-full" type="text" name="manufacturer_unit" :value="old('manufacturer_unit')" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="freight_company" class="block mt-1 w-full" type="text" name="freight_company" :value="old('freight_company')" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="freight_cost" class="block mt-1 w-full" type="number" step="0.01" name="freight_cost" :value="old('freight_cost')" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="expiration_date" class="block mt-1 w-full" type="date" name="expiration_date" :value="old('expiration_date')" />
                            ...
                            <div>
                                ...
                                <input id="image" class="block mt-1 w-full border border-gray-300 p-2 rounded" type="file" name="image" accept="image/*" />
