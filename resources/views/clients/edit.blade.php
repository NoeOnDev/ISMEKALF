                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('clients.update', $client) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="code" id="code" value="{{ old('code', $client->code) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="contact" id="contact" value="{{ old('contact', $client->contact) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="version" id="version" value="{{ old('version', $client->version) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
